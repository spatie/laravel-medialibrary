...
[Try a demo of the concept here.](/docs/laravel-medialibrary/v12/responsive-images/demo)
...
Behind the scenes, the media library will generate multiple size variations of your image. To learn which variations are generated and how to customize head over [here](/docs/laravel-medialibrary/v12/responsive-images/using-your-own-width-calculator).
...
You can also generate responsive images for any [image conversions](/docs/laravel-medialibrary/v12/converting-images/defining-conversions) you define. Simply use `withResponsiveImages` when defining a conversion.

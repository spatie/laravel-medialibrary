...
```bash
php artisan vendor:publish --provider="Programic\MediaLibrary\MediaLibraryServiceProvider" --tag="migrations"
```
...
```bash
php artisan vendor:publish --provider="Programic\MediaLibrary\MediaLibraryServiceProvider" --tag="config"
```

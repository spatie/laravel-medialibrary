...
Head over to [the installation page](https://spatie.be/docs/laravel-medialibrary/v12/installation-setup#content-setting-up-optimization-tools) to learn how to install these.

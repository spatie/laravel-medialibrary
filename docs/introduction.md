...
The package can also generate derived images such as thumbnails for images, videos and PDFs. Once you've [set up your model](/docs/laravel-medialibrary/v12/basic-usage/preparing-your-model), they're easily accessible:
...
[![video course](/docs/laravel-medialibrary/v12/images/video-course.jpg)](https://spatie.be/courses/discovering-laravel-media-library/introducing-laravel-media-library)

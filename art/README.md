...
**Laravel Media Library** logo is designed and maintained by [Caneco](https://twitter.com/caneco).

## License

All rights reserved, but with the following extra conditions:

- It is **OK** to use the Laravel Media Library logo in the following cases:
...
- It is **NOT OK** to use the Laravel Media Library logo in the following cases without prior written consent from the copyright owners:
    - Using the Laravel Media Library logo in a commercial product for purposes other than illustrating its integration.
    - Sell physical products that uses the Laravel Media Library logo or its variants, e.g. t-shirts.
